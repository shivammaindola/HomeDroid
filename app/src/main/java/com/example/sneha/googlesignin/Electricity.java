...
//        });
        ...
        adapterClass1 = new AdapterClassElectricity(Electricity1.Name, Electricity1.Number, Electricity.this);
    ...
    public void AddData() {
        ...
        if (isInserted == true) {
            Toast.makeText(Electricity.this, "Data inserted", Toast.LENGTH_LONG).show();
            Electricity1.Name.add(name.getText().toString().trim());
            Electricity1.Number.add(number.getText().toString().trim());
            adapterClass1.notifyDataSetChanged();
        } else
            Toast.makeText(Electricity.this, "Data is not inserted", Toast.LENGTH_LONG).show();
    }
