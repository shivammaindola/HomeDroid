...
public class EditElectricity extends AppCompatActivity {

    DatabaseElectricity myDb;
    EditText name, number, phone, password, email, address, username;
    ImageView pass_show;
    boolean pass_check = false;
    String connectionno;

    AdapterClassElectricity adapterClass1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_electricity);
...
//            }
//        });
        myDb = new DatabaseElectricity(this);
        adapterClass1 = new AdapterClassElectricity(Electricity1.Name, Electricity1.Number, EditElectricity.this);
    ...
    public void UpdateData() {
        ...
        if (isUpdated == true) {
            Toast.makeText(EditElectricity.this, "Data is updated", LENGTH_LONG).show();

        } else
            Toast.makeText(EditElectricity.this, "Data is not updated", LENGTH_LONG).show();
    }
