...
public class StickyNotes extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            case R.id.my_notees11 : startActivity(new Intent(StickyNotes.this,NoteEditorActivity1.class));
                return true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayAdapter1 = new ArrayAdapter(StickyNotes.this,android.R.layout.simple_list_item_1, notes);
        listView.setAdapter(arrayAdapter1);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(StickyNotes.this,NoteEditorActivity1.class);
                intent.putExtra("StickyId",position);
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                new android.app.AlertDialog.Builder(StickyNotes.this)
