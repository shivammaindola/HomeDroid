...
public class DisplayElectricity extends AppCompatActivity {
    TextView t1,t2,t3,t4,t5,t6,t7;
    DatabaseElectricity dataHelper;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(item.getItemId())
        {
            case R.id.my_notees1 :
                Intent intent = new Intent(DisplayElectricity.this,EditElectricity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_electricity);
        ...
        dataHelper = new DatabaseElectricity(this);
