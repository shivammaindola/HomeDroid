...
public class DisplayOnlineDetails extends AppCompatActivity {
    TextView t1,t2,t3,t4,t5;
    DatabaseOnline dataHelper;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(item.getItemId())
        {
            case R.id.my_notees1 :
                Intent intent = new Intent(DisplayOnlineDetails.this,EditOnline.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_online_details);
        ...
        dataHelper = new DatabaseOnline(this);
