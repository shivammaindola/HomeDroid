...
public class GoalSetting extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            case R.id.my_notees11 : startActivity(new Intent(GoalSetting.this,NoteEditorActivity3.class));
                return true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HashSet<String> set1 = (HashSet<String>) sharedPreferences1.getStringSet("goal",null);
        ...
        arrayAdapter1 = new ArrayAdapter(GoalSetting.this,android.R.layout.simple_list_item_1, notes);
        listView.setAdapter(arrayAdapter1);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(GoalSetting.this,NoteEditorActivity3.class);
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                new android.app.AlertDialog.Builder(GoalSetting.this)
