...
public class DatabaseGas extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = " gas.db";
    public static final String TABLE_NAME = "gas_table";
    ...
    public DatabaseGas(Context context) {
        ...
        if (res.moveToFirst()) {
            do {
                ...
                if (res.getString(0).toLowerCase().contains(a.toLowerCase()) || res.getString(1).toLowerCase().contains(a.toLowerCase()) ||
                    ...
                    Gas1.a.add(res.getString(1));
                    Gas1.b.add(res.getString(0));
