...
public class DisplayPanDetails extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(item.getItemId())
        {
            case R.id.my_notees1 :
                Intent intent = new Intent(DisplayPanDetails.this,EditPan.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_pan_details);
       ...
       // t5=(TextView)findViewById(R.id.dateofexpptextView);
        ...
        final  String namee = bundle.getString("pancardnumber");
